...
export default async function LandingPage() {
  ...
  return (
    <main className="marketing-site">
      ...
      <LearningProcessSection t={t} />
      <ModeCardsSection t={t} />
      <PublicModesSection priorityTopics={priorityTopics} t={t} />
      <SubjectHubsSection subjectPages={subjectPages} t={t} />
      <LearningPathsSection t={t} />
      <ContentEngineSection posts={posts} t={t} />
      <BlogHighlightsSection featuredPosts={featuredPosts} t={t} />
      <SchoolsSection t={t} />
      <FaqSection t={t} />
      <GithubSection t={t} />
      <MarketingFooter />
...
function LearningProcessSection({ t }: { t: LandingTranslator }) {
  return (
...
function PublicModesSection({ priorityTopics, t }: { priorityTopics: PriorityTopic[]; t: LandingTranslator }) {
  return (
    <section className="marketing-band is-discovery">
      ...
      <div className="marketing-inline-actions">
        <ArrowLink href="/chat/learn-anything">{t("Open guest chat")}</ArrowLink>
        <ArrowLink href="/topics">{t("Browse every mode")}</ArrowLink>
      </div>
    </section>
  );
}

function SubjectHubsSection({ subjectPages, t }: { subjectPages: SubjectPageSummary[]; t: LandingTranslator }) {
  return (
    <section className="marketing-band is-topic-finder">
      ...
      <div className="marketing-inline-actions">
        <ArrowLink href="/subjects">{t("Browse subjects")}</ArrowLink>
...
function LearningPathsSection({ t }: { t: LandingTranslator }) {
  return (
...
function ContentEngineSection({ posts, t }: { posts: LandingPost[]; t: LandingTranslator }) {
  return (
...
function BlogHighlightsSection({ featuredPosts, t }: { featuredPosts: LandingPost[]; t: LandingTranslator }) {
  return (
    <section className="marketing-band">
      <div className="marketing-section-copy">
...
function SchoolsSection({ t }: { t: LandingTranslator }) {
  return (
    <section className="marketing-split-band">
      <div>
        ...
        <div className="marketing-inline-actions">
          <ArrowLink href="/schools">{t("Explore schools")}</ArrowLink>
