...
const STATIC_ROUTES = [
  ...
  { pattern: '/weekly-reports', title: 'Weekly Reports', canonicalPath: '/weekly-reports', robots: 'noindex, nofollow' },
  {
    pattern: '/xp-leveling',
    title: 'XP & Leveling',
    description: 'Earn XP as you study and level up over time. A simple gamification layer to stay consistent.',
    canonicalPath: '/xp-leveling',
  },
  {
    pattern: '/badges',
    title: 'Badges & Achievements',
    description: 'Collect achievement badges as you hit milestones and build study habits.',
    canonicalPath: '/badges',
  },
  {
    pattern: '/leaderboards',
    title: 'Leaderboards',
    description: 'View the XP leaderboard and see who’s showing up consistently.',
    canonicalPath: '/leaderboards',
  },
  {
    pattern: '/challenges',
    title: 'Study Challenges',
    description: 'Create simple study challenges and track progress toward a clear target.',
    canonicalPath: '/challenges',
  },
  { pattern: '/progress-viz', title: 'Progress Visualization', canonicalPath: '/progress-viz', robots: 'noindex, nofollow' },
  { pattern: '/milestones', title: 'Milestones', canonicalPath: '/milestones', robots: 'noindex, nofollow' },
  { pattern: '/accountability', title: 'Accountability Partner', canonicalPath: '/accountability', robots: 'noindex, nofollow' },
  {
    pattern: '/note-organizer',
    title: 'Note Organizer',
    description: 'Tag and organize quick notes so they’re easy to find when you revise.',
    canonicalPath: '/note-organizer',
  },
  {
    pattern: '/study-planner',
    title: 'Study Planner',
    description: 'Plan your study sessions, exams, and deadlines with a simple study calendar.',
    canonicalPath: '/study-planner',
  },
  { pattern: '/course-manager', title: 'Course Manager', canonicalPath: '/course-manager', robots: 'noindex, nofollow' },
  { pattern: '/assignment-tracker', title: 'Assignment Tracker', canonicalPath: '/assignment-tracker', robots: 'noindex, nofollow' },
  {
    pattern: '/gpa-tracker',
    title: 'GPA Tracker',
    description: 'Track grade items and get a simple GPA estimate to guide your study priorities.',
    canonicalPath: '/gpa-tracker',
  },
  {
    pattern: '/schedule-builder',
    title: 'Study Schedule Builder',
    description: 'Build a weekly study schedule with repeatable time blocks.',
    canonicalPath: '/schedule-builder',
  },
  { pattern: '/study-groups', title: 'Study Groups', canonicalPath: '/study-groups', robots: 'noindex, nofollow' },
  { pattern: '/resource-sharing', title: 'Resource Sharing', canonicalPath: '/resource-sharing', robots: 'noindex, nofollow' },
  {
