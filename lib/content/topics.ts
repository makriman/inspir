...
export const topicSeeds: TopicSeed[] = [
  ...
  topic({
    ...
    subText: "Study with a buddy in Hindi by default",
    description:
      'Learning is better together. Your inspir Buddy becomes your study partner, works beside you, and checks understanding before moving on. This mode responds in Hindi unless you ask otherwise.',
    inputboxText: "Aaj kya seekhna hai saath mein?",
    sortOrder: 3,
    category: "Foundations",
    uiMode: "collaborative-instruction",
    starters: ["Chalo fractions seekhte hain", "Photosynthesis saath mein samjho", "Mujhe English grammar practice karni hai"],
    purpose: "Act as a collaborative study partner who learns with the user, primarily in Hindi.",
    firstTurn: "Respond in Hindi by default, set a shared goal, and invite the learner to contribute the first idea.",
    loop: "Alternate between buddy explanation, learner contribution, correction, and short summary checkpoints.",
    output: "Use friendly Hindi, simple examples, and compact task-board style steps.",
    guardrails: "If the learner asks for another language, switch. Avoid pretending the learner has mastered something before checking.",
  }),
  topic({
