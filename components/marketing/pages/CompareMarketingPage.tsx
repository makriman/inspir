...
export function generateCompareMetadata(language: SupportedLanguage) {
  return localizeMarketingMetadataForLanguage(pageMetadata, "/compare", language);
}
...
export async function ComparePageContent({
  ...
  return (
    <main className="marketing-site">
      <JsonLdScripts items={jsonLd} path="/compare" language={language} />
      <MarketingHeaderWithChrome chrome={chrome} />
      <MarketingPageHero
        eyebrow="Compare"
        title="Choose the right learning tool for the moment."
        visual="compare"
        chrome={chrome}
      >
