...
export function generateTopicsMetadata(language: SupportedLanguage) {
  return localizeMarketingMetadataForLanguage(pageMetadata, "/topics", language);
}

export async function TopicsPageContent({
  language,
  pathname,
}: {
  ...
  return (
    <main className="marketing-site">
      <JsonLdScripts items={jsonLd} path="/topics" language={language} />
      <MarketingHeaderWithChrome chrome={chrome} />
      <MarketingPageHero
        eyebrow="Learning modes"
        title="Start from the exact kind of help you need."
        visual="modes"
        chrome={chrome}
      >
