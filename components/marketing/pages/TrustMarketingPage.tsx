...
export function generateTrustMetadata(language: SupportedLanguage) {
  return localizeMarketingMetadataForLanguage(pageMetadata, "/trust", language);
}
...
export async function TrustPageContent({
  language,
  pathname,
}: {
  ...
  return (
    <main className="marketing-site">
      <JsonLdScripts items={jsonLd} path="/trust" language={language} />
