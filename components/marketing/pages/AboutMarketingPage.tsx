...
export function generateAboutMetadata(language: SupportedLanguage) {
  return localizeMarketingMetadataForLanguage(pageMetadata, "/about", language);
}
...
export async function AboutPageContent({
  ...
  return (
    <main className="marketing-site">
      <JsonLdScripts items={jsonLd} path="/about" language={language} />
      ...
      <section className="marketing-split-band">
        ...
        <div className="marketing-media-list">
          <ArrowLink href="/mission" hrefLanguage={hrefLanguage}>Read the mission</ArrowLink>
          <ArrowLink href="/schools" hrefLanguage={hrefLanguage}>Schools and CSR</ArrowLink>
      ...
      <section className="marketing-cta-band">
        ...
        <div className="marketing-inline-actions">
          ...
          <ArrowLink href="/blog" hrefLanguage={hrefLanguage}>Read the learning guides</ArrowLink>
        </div>
      </section>
