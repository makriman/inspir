          ...
          <article>
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-xl text-gray-700 mb-8">
                We built InspirQuiz with privacy as a core principle. This policy explains what data we collect
                (spoiler: not much) and what we do with it (even less).
              </p>
              ...
              <section className="mb-8">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
                  <h3 className="text-xl font-semibold text-deep-blue mb-3">If You Use InspirQuiz as a Guest</h3>
              ...
              <section className="mb-8">
                ...
                <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-dark">
                  <ul className="list-disc pl-6 text-gray-700 space-y-2">
                    ...
                    <li>No tracking cookies or analytics that follow you around the web</li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 text-gray-700 space-y-2">
                  ...
                  <li><strong>No tracking cookies:</strong> We don't use cookies to track your behavior, build profiles, or serve ads.</li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700">
                  InspirQuiz is designed to be safe for students of all ages, including children under 13. We don't
