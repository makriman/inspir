        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
              ...
              <p className="text-vibrant-yellow text-lg">
                Review all your completed quizzes
              </p>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-xl shadow-xl p-6">
              <p className="text-gray-600 text-sm font-semibold mb-2">Total Quizzes</p>
              <p className="text-4xl font-bold text-deep-blue">{history.length}</p>
            </div>
            <div className="bg-white rounded-xl shadow-xl p-6">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3">
              <h2 className="text-2xl font-bold text-deep-blue">All Quizzes</h2>
              <div className="flex items-center gap-2">
                <label className="text-sm font-medium text-gray-700">Sort by:</label>
                <select
                  value={sortBy}
                  onChange={(e) => setSortBy(e.target.value)}
                  className="px-4 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-deep-blue text-sm"
                >
            ...
            {sortedHistory.length === 0 ? (
              ...
              <div className="space-y-4">
                {sortedHistory.map((item) => (
                  <div
                    key={item.id}
                    className="border-2 border-gray-200 rounded-lg p-6 hover:border-deep-blue transition-all"
                  >
                    ...
                    {item.quiz_id && (
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                        <button
                          ...
                          className="px-3 py-2 bg-deep-blue text-white rounded-lg font-semibold hover:bg-opacity-90 transition-all flex items-center justify-center gap-1 text-sm"
                        >
                        ...
                        <button
                          ...
                          className="px-3 py-2 bg-vibrant-yellow text-deep-blue rounded-lg font-bold hover:bg-opacity-90 transition-all flex items-center justify-center gap-1 text-sm shadow-md"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button
                          ...
                          className="px-3 py-2 bg-coral-red text-white rounded-lg font-semibold hover:bg-opacity-90 transition-all disabled:opacity-50 flex items-center justify-center gap-1 text-sm"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {showShareModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-purple-gradient rounded-2xl max-w-md w-full p-8 relative">
              ...
              <h2 className="text-3xl font-bold text-white mb-4 text-center pr-8">
                Share This Quiz!
              </h2>
