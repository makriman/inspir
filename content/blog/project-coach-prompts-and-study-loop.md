---
title: "Project Coach prompts and study loop"
description: "Prompt ideas and a repeatable study loop for getting useful learning results from Project Coach on inspir."
date: "2026-04-28"
author: "inspir"
tags: [AI prompts, Planning, study skills]
---

The fastest way to get value from [Project Coach](/chat/project-coach) is to give the AI a learning job, not just a topic. A topic says what you are interested in. A learning job says what kind of help you need.

For this mode, the job is simple: Plan a school, creative, coding, or personal project with scope, milestones, blockers, and next actions.
...
For Project Coach, a useful practice loop is:
...
The best learning sessions are adjustable. This mode is tuned for project coach with its own prompts, examples, and learning flow.

## Related learning paths

Use [Project Coach](/chat/project-coach) when this is the right mode for the job. If you want a related path, try [Code Tutor](/chat/code-tutor). You can also browse the [AI learning blog](/blog) for study methods, Socratic learning, flashcards, roleplay, and active recall.
