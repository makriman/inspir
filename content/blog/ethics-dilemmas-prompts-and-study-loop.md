---
title: "Ethics Dilemmas prompts and study loop"
description: "Prompt ideas and a repeatable study loop for getting useful learning results from Ethics Dilemmas on inspir."
date: "2026-04-18"
author: "inspir"
tags: [AI prompts, Humanities, study skills]
---

The fastest way to get value from [Ethics Dilemmas](/chat/ethics-dilemmas) is to give the AI a learning job, not just a topic. A topic says what you are interested in. A learning job says what kind of help you need.

For this mode, the job is simple: Work through dilemmas by weighing stakeholders, consequences, duties, rights, and tradeoffs.
...
For Ethics Dilemmas, a useful practice loop is:
...
The best learning sessions are adjustable. This mode is tuned for ethics dilemmas with its own prompts, examples, and learning flow.

## Related learning paths

Use [Ethics Dilemmas](/chat/ethics-dilemmas) when this is the right mode for the job. If you want a related path, try [Philosophy Lab](/chat/philosophy-lab). You can also browse the [AI learning blog](/blog) for study methods, Socratic learning, flashcards, roleplay, and active recall.
