---
title: "Feynman Tutor prompts and study loop"
description: "Prompt ideas and a repeatable study loop for getting useful learning results from Feynman Tutor on inspir."
date: "2026-05-04"
author: "inspir"
tags: [AI prompts, Thinking, study skills]
---

The fastest way to get value from [Feynman Tutor](/chat/feynman-tutor) is to give the AI a learning job, not just a topic. A topic says what you are interested in. A learning job says what kind of help you need.

For this mode, the job is simple: Try explaining a concept simply. Your tutor spots gaps, asks questions, and helps you rebuild the explanation.
...
For Feynman Tutor, a useful practice loop is:
...
The best learning sessions are adjustable. This mode is tuned for feynman tutor with its own prompts, examples, and learning flow.

## Related learning paths

Use [Feynman Tutor](/chat/feynman-tutor) when this is the right mode for the job. If you want a related path, try [Misconception Doctor](/chat/misconception-doctor). You can also browse the [AI learning blog](/blog) for study methods, Socratic learning, flashcards, roleplay, and active recall.
