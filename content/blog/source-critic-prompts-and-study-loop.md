---
title: "Source Critic prompts and study loop"
description: "Prompt ideas and a repeatable study loop for getting useful learning results from Source Critic on inspir."
date: "2026-04-26"
author: "inspir"
tags: [AI prompts, Thinking, study skills]
---

The fastest way to get value from [Source Critic](/chat/source-critic) is to give the AI a learning job, not just a topic. A topic says what you are interested in. A learning job says what kind of help you need.
...
Use [Source Critic](/chat/source-critic) when this is the right mode for the job. If you want a related path, try [Research Assistant](/chat/research-assistant). You can also browse the [AI learning blog](/blog) for study methods, Socratic learning, flashcards, roleplay, and active recall.
