---
title: "Research Assistant AI Learning Mode: practical guide"
description: "A practical guide to using Research Assistant on inspir for thinking learning, with prompts, study loops, and safer AI habits."
date: "2026-04-27"
author: "inspir"
tags: [AI tutor, Thinking, Research Assistant]
---

Research Assistant AI Learning Mode is a focused way to use AI for learning instead of passive answer collection. The mode is built around a specific job: Turn a broad topic into research questions, search terms, outlines, and source notes.
...
Use [Research Assistant](/chat/research-assistant) when you want a session that starts quickly but still adapts to you. The first goal is not to sound impressive. The first goal is to make the next step feel possible.
...
Start the live mode at [Research Assistant](/chat/research-assistant). If you want a neighboring learning format, try [Source Critic](/chat/source-critic). For a broader view of the platform, read [what an AI learning companion should do for everyone](/blog/ai-learning-companion-for-everyone).
