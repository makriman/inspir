---
title: "Collaborative Instruction prompts and study loop"
description: "Prompt ideas and a repeatable study loop for getting useful learning results from Collaborative Instruction on inspir."
date: "2026-05-26"
author: "inspir"
tags: [AI prompts, Foundations, study skills]
---

The fastest way to get value from [Collaborative Instruction](/chat/collaborative-instruction) is to give the AI a learning job, not just a topic. A topic says what you are interested in. A learning job says what kind of help you need.

For this mode, the job is simple: Open a shared workspace with an AI collaborator. Make a rough artifact, trade edits, challenge weak spots, log decisions, and leave with concrete progress.
...
For Collaborative Instruction, a useful practice loop is:
...
The best learning sessions are adjustable. This mode is tuned for collaborative instruction with its own prompts, examples, and learning flow.

## Related learning paths

Use [Collaborative Instruction](/chat/collaborative-instruction) when this is the right mode for the job. If you want a related path, try [Socratic Instruction](/chat/socratic-instruction). You can also browse the [AI learning blog](/blog) for study methods, Socratic learning, flashcards, roleplay, and active recall.
