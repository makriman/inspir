---
title: "Research Assistant prompts and study loop"
description: "Prompt ideas and a repeatable study loop for getting useful learning results from Research Assistant on inspir."
date: "2026-04-27"
author: "inspir"
tags: [AI prompts, Thinking, study skills]
---

The fastest way to get value from [Research Assistant](/chat/research-assistant) is to give the AI a learning job, not just a topic. A topic says what you are interested in. A learning job says what kind of help you need.

For this mode, the job is simple: Turn a broad topic into research questions, search terms, outlines, and source notes.
...
For Research Assistant, a useful practice loop is:
...
The best learning sessions are adjustable. This mode is tuned for research assistant with its own prompts, examples, and learning flow.

## Related learning paths

Use [Research Assistant](/chat/research-assistant) when this is the right mode for the job. If you want a related path, try [Project Coach](/chat/project-coach). You can also browse the [AI learning blog](/blog) for study methods, Socratic learning, flashcards, roleplay, and active recall.
