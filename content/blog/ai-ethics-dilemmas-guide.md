---
title: "Ethics Dilemmas AI Learning Mode: practical guide"
description: "A practical guide to using Ethics Dilemmas on inspir for humanities learning, with prompts, study loops, and safer AI habits."
date: "2026-04-18"
author: "inspir"
tags: [AI tutor, Humanities, Ethics Dilemmas]
---

Ethics Dilemmas AI Learning Mode is a focused way to use AI for learning instead of passive answer collection. The mode is built around a specific job: Work through dilemmas by weighing stakeholders, consequences, duties, rights, and tradeoffs.
...
Use [Ethics Dilemmas](/chat/ethics-dilemmas) when you want a session that starts quickly but still adapts to you. The first goal is not to sound impressive. The first goal is to make the next step feel possible.
...
This mode is tuned for ethics dilemmas with its own prompts, examples, and learning flow.
...
Start the live mode at [Ethics Dilemmas](/chat/ethics-dilemmas). If you want a neighboring learning format, try [Geography Explorer](/chat/geography-explorer). For a broader view of the platform, read [what an AI learning companion should do for everyone](/blog/ai-learning-companion-for-everyone).
