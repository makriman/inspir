---
title: "Project Coach AI Learning Mode: practical guide"
description: "A practical guide to using Project Coach on inspir for planning learning, with prompts, study loops, and safer AI habits."
date: "2026-04-28"
author: "inspir"
tags: [AI tutor, Planning, Project Coach]
---

Project Coach AI Learning Mode is a focused way to use AI for learning instead of passive answer collection. The mode is built around a specific job: Plan a school, creative, coding, or personal project with scope, milestones, blockers, and next actions.
...
Use [Project Coach](/chat/project-coach) when you want a session that starts quickly but still adapts to you. The first goal is not to sound impressive. The first goal is to make the next step feel possible.

This mode is especially useful for learners who want to:

- Turn ideas into milestones.
- Start with example prompts.
- Adapt the session to your goal.

## Why it is different from a generic chatbot

This mode is tuned for project coach with its own prompts, examples, and learning flow.
...
- "Organize a history presentation"
...
Start the live mode at [Project Coach](/chat/project-coach). If you want a neighboring learning format, try [Research Assistant](/chat/research-assistant). For a broader view of the platform, read [what an AI learning companion should do for everyone](/blog/ai-learning-companion-for-everyone).
